...
class Ui_Manager(object):
    def setupUi(self, Manager):
        ...
        self.QPUserTW = QtWidgets.QTableWidget(self.tab)
        self.QPUserTW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.QPUserTW.setAlternatingRowColors(True)
        self.QPUserTW.setColumnCount(4)
        self.QPUserTW.setObjectName("QPUserTW")
        self.QPUserTW.setRowCount(0)
        self.QPUserTW.horizontalHeader().setStretchLastSection(True)
        self.QPUserTW.verticalHeader().setVisible(False)
    ...
    def retranslateUi(self, Manager):
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab), _translate("Manager", "Question Progress by &User"))
