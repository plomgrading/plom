...
% we also give a blank page that only prints in the solutions
% this is useful to pad your solution pdf so that it has the same structure
% as your test pdf - this makes auto-extracting solutions easier.

\newcommand{\solnpage}[1][\thequestion]{
\ifthenelse{\boolean{space}}{}{
\pagebreak
\noindent \emph{This blank page is to pad the PDF when showing solutions for \textbf{Question~{#1}}.}
\pagebreak
}}
