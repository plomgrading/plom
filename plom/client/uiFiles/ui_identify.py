...
class Ui_IdentifyWindow(object):
    def setupUi(self, IdentifyWindow):
        ...
        self.rightPane = QtWidgets.QWidget(IdentifyWindow)
        ...
        self.verticalLayout_2.addWidget(self.predictionBox)
        ...
        self.verticalLayout_2.addWidget(self.paperBox)
        self.gridLayout_5.addWidget(self.rightPane, 0, 1, 5, 1)
