...
class Ui_IdentifyWindow(object):
    def setupUi(self, IdentifyWindow):
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.rightPane)
        ...
        self.verticalLayout_3.addWidget(self.predictionBox)
        self.paperBox = QtWidgets.QGroupBox(self.rightPane)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.paperBoxLayout = QtWidgets.QGridLayout(self.paperBox)
        self.paperBoxLayout.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.paperBoxLayout.setObjectName("paperBoxLayout")
        self.verticalLayout_3.addWidget(self.paperBox)
