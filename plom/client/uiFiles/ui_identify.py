...
class Ui_IdentifyWindow(object):
    def setupUi(self, IdentifyWindow):
        ...
        self.label = QtWidgets.QLabel(self.studentBox)
...
" prediction"))
        ...
        self.studentBox.setTitle(_translate("IdentifyWindow", "Enter student ID or name:"))
        self.label.setText(_translate("IdentifyWindow", "then press enter to continue"))
