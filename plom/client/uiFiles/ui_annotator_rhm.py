...
class Ui_annotator_rhm(object):
    def setupUi(self, annotator_rhm):
        ...
        self.refreshCommentsButton = QtWidgets.QPushButton(self.frame6)
        self.refreshCommentsButton.setObjectName("refreshCommentsButton")
        self.hboxlayout.addWidget(self.refreshCommentsButton)
    ...
    def retranslateUi(self, annotator_rhm):
        ...
        self.refreshCommentsButton.setText(_translate("annotator_rhm", "Refresh Comments"))
