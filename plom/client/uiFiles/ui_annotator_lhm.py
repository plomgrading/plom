...
class Ui_annotator_lhm(object):
    def setupUi(self, annotator_lhm):
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(annotator_lhm)
        ...
        self.horizontalLayout_2.addWidget(self.pageFrame)
        ...
        self.horizontalLayout_2.addWidget(self.revealBox0)
        ...
        self.ebLayout.setContentsMargins(3, 3, 3, 6)
        ...
        self.horizontalLayout_2.addWidget(self.hideableBox)
    ...
    def retranslateUi(self, annotator_lhm):
        ...
        self.modeLabel.setText(_translate("annotator_lhm", "<mode>"))
