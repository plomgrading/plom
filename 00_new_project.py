...
files += ['build/01_build_specification_gui.py', 'build/cleanAll.py', 'build/editMeToBuildASpec.py', 'build/02_build_tests_from_spec.py', 'build/mergeAndCodePages.py', 'build/buildTestPDFs.py', 'build/ui_builder.py']
files += [
