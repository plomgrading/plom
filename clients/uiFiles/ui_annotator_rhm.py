...
class Ui_annotator_rhm(object):
    def setupUi(self, annotator_rhm):
        ...
        self.markLine = QtWidgets.QLineEdit(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.markLine.sizePolicy().hasHeightForWidth())
        self.markLine.setSizePolicy(sizePolicy)
        self.markLine.setAlignment(QtCore.Qt.AlignCenter)
        self.markLine.setReadOnly(True)
        self.markLine.setObjectName("markLine")
        self.modeLayout.addWidget(self.markLine)
        ...
        self.revealBox2 = QtWidgets.QFrame(annotator_rhm)
        ...
        self.gridLayout.addWidget(self.revealBox2, 4, 2, 1, 1)
        self.revealBox = QtWidgets.QFrame(annotator_rhm)
        self.revealBox.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.revealBox.setFrameShadow(QtWidgets.QFrame.Raised)
        self.revealBox.setObjectName("revealBox")
        self.revealLayout = QtWidgets.QGridLayout(self.revealBox)
        self.revealLayout.setObjectName("revealLayout")
        self.deltaButton = QtWidgets.QToolButton(self.revealBox)
        self.deltaButton.setObjectName("deltaButton")
        self.revealLayout.addWidget(self.deltaButton, 1, 0, 1, 1)
        self.gridLayout.addWidget(self.revealBox, 0, 2, 3, 1)
