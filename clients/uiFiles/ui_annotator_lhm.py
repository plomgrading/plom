...
class Ui_annotator_lhm(object):
    def setupUi(self, annotator_lhm):
        ...
        self.markBox = QtWidgets.QGroupBox(annotator_lhm)
        ...
        self.gridLayout.addWidget(self.markBox, 1, 1, 1, 1)
        self.groupBox_3 = QtWidgets.QGroupBox(annotator_lhm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.frame_2 = QtWidgets.QFrame(annotator_lhm)
        ...
        self.gridLayout.addWidget(self.pageFrame, 0, 0, 4, 1)
        self.groupBox = QtWidgets.QGroupBox(annotator_lhm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.gridLayout_3.addWidget(self.commentButton, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.tickButton, 1, 1, 1, 1)
        self.textButton = QtWidgets.QToolButton(self.groupBox)
        self.textButton.setObjectName("textButton")
        self.gridLayout_3.addWidget(self.textButton, 1, 2, 1, 1)
        ...
        annotator_lhm.setTabOrder(self.textButton, self.finishedButton)
    ...
    def retranslateUi(self, annotator_lhm):
        ...
        self.crossButton.setToolTip(_translate("annotator_lhm", "press s or k"))
        self.crossButton.setText(_translate("annotator_lhm", "..."))
        self.penButton.setToolTip(_translate("annotator_lhm", "press w or i"))
        self.penButton.setText(_translate("annotator_lhm", "..."))
        self.redoButton.setToolTip(_translate("annotator_lhm", "press q or u"))
        self.redoButton.setText(_translate("annotator_lhm", "..."))
        self.panButton.setToolTip(_translate("annotator_lhm", "press r or p"))
        self.panButton.setText(_translate("annotator_lhm", "..."))
        self.commentButton.setToolTip(_translate("annotator_lhm", "press a or j"))
        self.commentButton.setText(_translate("annotator_lhm", "..."))
        self.tickButton.setToolTip(_translate("annotator_lhm", "press a or j"))
        self.tickButton.setText(_translate("annotator_lhm", "..."))
        self.textButton.setToolTip(_translate("annotator_lhm", "press f or semi-colon"))
        self.textButton.setText(_translate("annotator_lhm", "..."))
        self.undoButton.setToolTip(_translate("annotator_lhm", "press z or m"))
        self.undoButton.setText(_translate("annotator_lhm", "..."))
        self.zoomButton.setToolTip(_translate("annotator_lhm", "press e or o"))
        self.zoomButton.setText(_translate("annotator_lhm", "..."))
        self.commentDownButton.setToolTip(_translate("annotator_lhm", "press a or j"))
        self.commentDownButton.setText(_translate("annotator_lhm", "..."))
        self.boxButton.setToolTip(_translate("annotator_lhm", "press d or l"))
        self.boxButton.setText(_translate("annotator_lhm", "..."))
        self.lineButton.setToolTip(_translate("annotator_lhm", "press x or comma"))
        self.lineButton.setText(_translate("annotator_lhm", "..."))
        self.deleteButton.setToolTip(_translate("annotator_lhm", "press c or period"))
        self.deleteButton.setText(_translate("annotator_lhm", "..."))
        self.moveButton.setToolTip(_translate("annotator_lhm", "press v or /"))
