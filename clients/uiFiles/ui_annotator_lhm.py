...
class Ui_annotator_lhm(object):
    def setupUi(self, annotator_lhm):
        ...
        self.toolLayout.addWidget(self.undoButton, 2, 7, 1, 1)
        ...
        self.toolLayout.addWidget(self.moveButton, 3, 8, 1, 1)
        ...
        self.toolLayout.addWidget(self.zoomButton, 2, 8, 1, 1)
        ...
        self.toolLayout.addWidget(self.panButton, 0, 8, 1, 1)
        ...
        self.toolLayout.addWidget(self.crossButton, 0, 6, 1, 1)
        ...
        self.toolLayout.addWidget(self.tickButton, 2, 6, 1, 1)
        ...
        self.toolLayout.addWidget(self.boxButton, 3, 6, 1, 1)
