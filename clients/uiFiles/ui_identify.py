...
class Ui_IdentifyWindow(object):
    def setupUi(self, IdentifyWindow):
        ...
        self.idLabel = QtWidgets.QLabel(self.studentBox)
        ...
        self.gridLayout_3.addWidget(self.tableBox, 3, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.widget_2, 0, 1, 2, 1)

        self.retranslateUi(IdentifyWindow)
        QtCore.QMetaObject.connectSlotsByName(IdentifyWindow)
        IdentifyWindow.setTabOrder(self.idEdit, self.nameEdit)
        IdentifyWindow.setTabOrder(self.nameEdit, self.nextButton)
