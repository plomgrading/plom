...
class Ui_Chooser(object):
    def setupUi(self, Chooser):
        ...
        self.gridLayout.addWidget(self.serverLE, 1, 1, 1, 2)
        ...
        self.infoLabel2 = QtWidgets.QLabel(self.serverGBox)
        self.infoLabel2.setText("")
        self.infoLabel2.setObjectName("infoLabel2")
        self.horizontalLayout_3.addWidget(self.infoLabel2)
        self.pgGet = QtWidgets.QPushButton(self.serverGBox)
        self.pgGet.setText("...")
        self.pgGet.setObjectName("pgGet")
        self.horizontalLayout_3.addWidget(self.pgGet)
    ...
    def retranslateUi(self, Chooser):
        ...
        self.infoLabel.setText(_translate("Chooser", "Server info:"))
