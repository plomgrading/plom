...
class Ui_IIC(object):
    def setupUi(self, IIC):
        ...
        self.overallTW = QtWidgets.QTableWidget(self.tab_4)
        ...
        self.refreshOButton = QtWidgets.QPushButton(self.tab_4)
        ...
        self.predictionTW.setColumnCount(2)
    ...
    def retranslateUi(self, IIC):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("IIC", "Overall &Progress"))
