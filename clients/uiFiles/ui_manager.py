...
class Ui_Manager(object):
    def setupUi(self, Manager):
        ...
        self.progressTabW.addTab(self.tab_2, "")
        ...
        self.reviewTTab.setEnabled(False)
    ...
    def retranslateUi(self, Manager):
        ...
        self.progressTabW.setTabText(self.progressTabW.indexOf(self.tab_2), _translate("Manager", "&Totalling Progress"))
