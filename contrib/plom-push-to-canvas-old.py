...
Overview:
  ...
  4. Run this script and follow the interactive menus:
     ```
     ./plom-push-to-canvas-old.py --dry-run
     ```
  ...
  5. Note that you can provide command line arguments and/or
     ...
     ```
     ./plom-push-to-canvas-old.py --help
     ```
  6. Run it again for real:
     ```
     ./plom-push-to-canvas-old.py --course xxxxxx --assignment xxxxxxx --no-section 2>&1 | tee push.log
     ```
