...
class QuestionClusteringChore(HueyTaskTracker):
    ...
    question: the question_index of the question being clustered
    ...
    def __str__(self):
        ...
        return f"Cluster question: {self.question}, version: {self.version}"
...
class QVCluster(models.Model):
    ...
    class Meta:
        unique_together = ("question", "version", "clusterId")
