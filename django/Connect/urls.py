...
urlpatterns = [
    ...
    path('send_info/init_db_progress/', CoreDBStatusView.as_view(), name='connect_db_status'),
    path('send_info/init_db_update/', CoreDBRefreshStatus.as_view(), name='connect_db_update')
]