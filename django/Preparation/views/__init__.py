from .needs_manager_view import ManagerRequiredBaseView
...
from .pqv_mapping import PQVMappingView, PQVMappingDownloadView, PQVMappingDeleteView, PQVMappingUploadView
