...
urlpatterns = [
    ...
    path("classlist/delete", ClasslistDeleteView.as_view(), name='prep_classlist_delete'),
    path("qvmapping/", PQVMappingView.as_view(), name='prep_qvmapping'),
    path("qvmapping/download", PQVMappingDownloadView.as_view(), name='prep_qvmapping_download'),
    path("qvmapping/delete", PQVMappingDeleteView.as_view(), name='prep_qvmapping_delete'),
