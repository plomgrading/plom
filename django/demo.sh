...
echo "Avoid perplexing errors by removing autogen migration droppings"
{
    ...
    echo "It seems there are no old migrations to worry about."
}

echo "**********************************************"
echo "Removing old DB and any misc user-generated files"
rm -f db.sqlite3
rm -f huey/huey_db.*
...
echo "**********************************************"
echo "Rebuild the database migrations and migrate"
...
echo "**********************************************"
echo "Upload a demo spec and demo test sources"
...
echo "**********************************************"
echo "Enable prenaming and upload classlist"
...
echo "**********************************************"
echo "Build the question-version map"
...
echo "**********************************************"
echo "Launch huey workers for background processes"
...
echo "**********************************************"
echo "Start building of paper pdfs"
python3 manage.py plom_build_papers --start-all
