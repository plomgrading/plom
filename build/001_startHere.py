...
print("To start the build process")
print(
    '0. Find your source PDFs and copy them to the "sourceVersions" directory as version1.pdf, version2.pdf, etc'
)
print(
...
print('4. Run the "004_buildPDFs.py" script.')
