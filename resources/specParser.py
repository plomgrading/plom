...
class SpecParser:
    def __init__(self):
        ...
        self.spec = toml.load("../resources/verifiedSpec.toml")
...
class SpecVerifier:
    ...
    def saveVerifiedSpec(self):
        ...
        with open("../resources/verifiedSpec.toml", "w+") as fh:
            fh.write("# This file is produced by the 002 script.\n")
            fh.write(
                "# Do not edit this file. Instead edit testSpec.toml and rerun 002.\n"
            )
            fh.write("# Omer - this includes you.\n")
